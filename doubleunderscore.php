        ...
        <div class="row align-items-center">
          ...
          <div class="col-10 col-md-8 d-none d-xl-block" data-aos="fade-down">
            ...
            <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="active"><a href="doubleunderscore.php">@__.doubleunderscore</a></li>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-7">
          <div class="row mb-5">
            <div class="col-12 ">
            <center><img src="E:\My Pictures\fOLDER\DSC_0070.jpg" class="image--cover"></center>

              <h2 class="site-section-heading text-center">@__.doubleunderscore's Gallery</h2>
            </div>
          </div>
        </div>
      ...
      <?php
        ...
        $sql="select * from user_image where Username='doubleunderscore'";
