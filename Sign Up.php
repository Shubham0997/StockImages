...
<html lang="en">
            ...
            <div class="col-lg-8 mb-5">
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-md-12">
                    <label class="text-black" for="Password">Pick a Profile Picture</label> 
  ...
  if(mysqli_num_rows($result)>0){ echo '<script>alert("Username Already Exists")</script>';}
    ...
    $q="insert into signup(name,loc,type,size,F_name,L_name,Username,Email,Password) values ('$file','$loc','$type','$size','$fn','$ln','$un','$em','$password')";
