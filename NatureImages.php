          ...
          <div class="col-10 col-md-8 d-none d-xl-block" data-aos="fade-down">
            ...
            <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li class="active"><a href="NatureImages.php">Nature</a></li>
  ...
  <div class="site-section"  data-aos="fade">
    <div class="container-fluid">
      ...
      <?php
        ...
        $sql="select * from user_image where ImageCategory='Nature'";
        $result=mysqli_query($c,$sql);
        $x = 1; 
        while($row=mysqli_fetch_array($result)){
   
       echo" <div class='col-sm-6 col-md-4 col-lg-3 col-xl-2 item' data-aos='fade' data-src='upload/".$row['name']."' data-sub-html='<p>".$row['ImageDescription']."</p>'> <input type=button value='Buy Now' class='btn btn-primary py-2 px-4 text-white'>";
       echo"<form method='get' action='/page2'>";  
