    ...
    <div class="swiper-container images-carousel">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="image-wrap">
                <div class="image-info">
                  ...
                  <a href="NatureImages.php" class="btn btn-outline-white py-2 px-4">More Photos</a>
                </div>
            ...
            <div class="swiper-slide">
              <div class="image-wrap">
                <div class="image-info">
                  ...
                  <a href="PortraitImages.php" class="btn btn-outline-white py-2 px-4">More Photos</a>
                </div>
            ...
            <div class="swiper-slide">
              <div class="image-wrap">
                <div class="image-info">
                  ...
                  <a href="StreetImages.php" class="btn btn-outline-white py-2 px-4">More Photos</a>
                </div>
                <img src="images/selective-focus-photo-of-road-1707820.jpg" alt="Image">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="image-wrap">
                <div class="image-info">
                  <h2 class="mb-3">Wildlife</h2>
                  <a href="WildlifeImages.php" class="btn btn-outline-white py-2 px-4">More Photos</a>
                </div>
            ...
            <div class="swiper-slide">
              <div class="image-wrap">
                <div class="image-info">
                  <h2 class="mb-3">Landscape</h2>
                  <a href="LandscapeImages.php" class="btn btn-outline-white py-2 px-4">More Photos</a>
                </div>
                <img src="images/person-on-a-bridge-near-a-lake-747964.jpg" alt="Image">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="image-wrap">
                <div class="image-info">
                  ...
                  <a href="TravelImages.php" class="btn btn-outline-white py-2 px-4">More Photos</a>
                </div>
                <img src="images/man-wearing-white-shirt-brown-shorts-and-green-backpack-672358.jpg" alt="Image">
              </div>
            </div>
        </div>
