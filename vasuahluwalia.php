        ...
        <div class="row align-items-center">
          ...
          <div class="col-10 col-md-8 d-none d-xl-block" data-aos="fade-down">
            ...
            <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="active"><a href="vasuahluwalia.php">@vasu_ahluwalia</a></li>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-7">
          <div class="row mb-5">
            <div class="col-12 ">
              <h2 class="site-section-heading text-center">@vasu_ahluwalia's Gallery</h2>
            </div>
          </div>
        </div>
      ...
      <?php
        ...
        $sql="select * from user_image where Username='vasuahluwalia'";
