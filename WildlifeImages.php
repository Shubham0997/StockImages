            ...
            <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    ...
                    <li class="active"><a href="WildlifeImages.php">Wildlife</a></li>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-7">
          <div class="row mb-5">
            <div class="col-12 ">
              <h2 class="site-section-heading text-center">Wildlife Gallery</h2>
            </div>
          </div>
        </div>
      ...
      <?php
        ...
        $sql="select * from user_image where ImageCategory='Wildlife'";
